  ...
  return (
    <div className='bg-white border-blue-950 border rounded-md'>
     ...
     <div className="space-y-4">
          <h2 className="text-xl font-bold my-4 text-center">Additional Details</h2>
          <form className='mx-auto max-w-md py-4'>
            ...
            <div className="mb-4">
              ...
              <input
                type="text"
                className="w-full p-2 border border-gray-300 rounded-md focus:outline-none focus:border-[2px] focus:border-blue-950"
